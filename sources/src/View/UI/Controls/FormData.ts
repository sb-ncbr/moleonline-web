namespace Controls.UI{
    ...
    export class Cavity implements Service.MoleConfigCavity{
    ...
    export class Input implements Service.MoleConfigInput{
    ...
    export class Tunnel implements Service.MoleConfigTunnel{
    ...
    export class Origin implements Service.MoleConfigOrigin{
