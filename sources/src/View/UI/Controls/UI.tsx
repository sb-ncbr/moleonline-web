        ...
        getPoresForm(){
            ...
            return <div className="settings-form basic-settings pores">
                        ...
                        <Common.Controls.FromLiteMol.LMControlWrapper controls={[
                            ...
                            <Common.Controls.FromLiteMol.TextBox label="Specific Chains" defaultValue={chains} tooltip={TooltipText.get("chains")} placeholder="A, B, ..." validate={CommonUtils.Validators.validateChainsArray} validationGroup={validationGroup} onChange={(val)=>{
                                if(this.state.poresFormData!==null){
